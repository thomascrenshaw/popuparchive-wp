...
Plugin URI: http://circadigital.biz
Description: This plugin will let you embed Pop Up Archive audio files and entities/tags into your posts and pages.
...
if (!class_exists('Popuparchive_WP')) {
     ...
     * @since 1.0.0
     * 
     * @todo must must must add a get_instance class to ensure not creating multiple instances of popuparchive
     * 
     *
